              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  ...
                  >
                    ...
                    <option value="International Science and Invention Fair - Online Competition">
                      Online Competition
                    </option>
                    <option value="International Science and Invention Fair - Online Competition + Certificate and Medal (SOUTH EAST ASIA ONLY)">
                      Online Competition + Certificate and Medal (SOUTH EAST
                      ASIA)
                    </option>
                    <option value="International Science and Invention Fair - Online Competition + Certificate and Medal (Exclude SOUTH EAST ASIA)">
