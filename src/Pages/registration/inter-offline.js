...
export default function InternationalOffline() {
  ...
  const router = useHistory(); // React Router hook untuk navigasi
  ...
  const handleCategoryChange = (e) => {
    ...
    switch (value) {
      case "International Science and Invention Fair - Offline Competition":
        break;
      case "International Science and Invention Fair - Offline Competition + Full Package":
        break;
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  ...
                  >
                    ...
                    <option value="International Science and Invention Fair - Offline Competition">
                      Offline Competition
                    </option>
                    <option value="International Science and Invention Fair - Offline Competition + Full Package">
                      Offline Competition + Full Package
                    </option>
                    <option value="International Science and Invention Fair - Offline Competition + Excursion">
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  ...
                  >
                    ...
                    <option value="ISIF Instagram">ISIF Instagram</option>
