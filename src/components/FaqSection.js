                                ...
                                <div id="accordion3">
                                    ...
                                    <div className="card">
                                        <div className="card-header" id="heading-During-One">
                                            <h5 className="mb-0">
                                                <button className="btn btn-link" data-toggle="collapse" data-target="#collapse-During-One" aria-expanded="true" aria-controls="collapse-During-One">
                                                    When will the presentation schedule be given by the committee?<i className="ti-plus"></i><i className="ti-minus"></i>
                                                </button>
                                            </h5>
                                        </div>

                                        <div id="collapse-During-One" className="collapse show" aria-labelledby="heading-During-One" data-parent="#accordion3">
                                            <div className="card-body">
                                    ...
                                    <div className="card">
                                        <div className="card-header" id="heading-During-Two">
                                            <h5 className="mb-0">
                                                <button className="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse-During-Two" aria-expanded="false" aria-controls="collapse-During-Two">
                                                What application used for online presentation? Zoom, Google Meet or something else?<i className="ti-plus"></i><i className="ti-minus"></i>
                                                </button>
                                            </h5>
                                        </div>
                                        <div id="collapse-During-Two" className="collapse" aria-labelledby="heading-During-Two" data-parent="#accordion3">
                                            <div className="card-body">
                                    ...
                                    <div className="card">
                                        <div className="card-header" id="heading-During-Three">
                                            <h5 className="mb-0">
                                                <button className="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse-During-Three" aria-expanded="false" aria-controls="collapse-During-Three">
                                                When will the zoom link be given by the committee?<i className="ti-plus"></i><i className="ti-minus"></i>
                                                </button>
                                            </h5>
                                        </div>
                                        <div id="collapse-During-Three" className="collapse" aria-labelledby="heading-During-Three" data-parent="#accordion3">
                                            <div className="card-body">
                                    ...
                                    <div className="card">
                                        <div className="card-header" id="heading-During-four">
                                            <h5 className="mb-0">
                                                <button className="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse-During-four" aria-expanded="false" aria-controls="collapse-During-four">
                                                how many zoom accounts can join and what should i set my name<i className="ti-plus"></i><i className="ti-minus"></i>
                                                </button>
                                            </h5>
                                        </div>
                                        <div id="collapse-During-four" className="collapse" aria-labelledby="heading-During-four" data-parent="#accordion3">
                                            <div className="card-body">
                                    ...
                                    <div className="card">
                                        <div className="card-header" id="heading-During-five">
                                            <h5 className="mb-0">
                                                <button className="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse-During-five" aria-expanded="false" aria-controls="collapse-During-five">
                                                how long will the participants make the presentation?<i className="ti-plus"></i><i className="ti-minus"></i>
                                                </button>
                                            </h5>
                                        </div>
                                        <div id="collapse-During-five" className="collapse" aria-labelledby="heading-During-five" data-parent="#accordion3">
                                            <div className="card-body">
                                    ...
                                    <div className="card">
                                        <div className="card-header" id="heading-During-six">
                                            <h5 className="mb-0">
                                                <button className="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse-During-six" aria-expanded="false" aria-controls="collapse-During-six">
                                                How many judges will come to the offline participants booth?<i className="ti-plus"></i><i className="ti-minus"></i>
                                                </button>
                                            </h5>
                                        </div>
                                        <div id="collapse-During-six" className="collapse" aria-labelledby="heading-During-six" data-parent="#accordion3">
                                            <div className="card-body">
                                    ...
                                    <div className="card">
                                        <div className="card-header" id="heading-During-seven">
                                            <h5 className="mb-0">
                                                <button className="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse-During-seven" aria-expanded="false" aria-controls="collapse-During-seven">
                                                Can we tidy up our booth after being judged?<i className="ti-plus"></i><i className="ti-minus"></i>
                                                </button>
                                            </h5>
                                        </div>
                                        <div id="collapse-During-seven" className="collapse" aria-labelledby="heading-During-seven" data-parent="#accordion3">
                                            <div className="card-body">
                                ...
                                <div id="accordion3">
                                    ...
                                    <div className="card">
                                        <div className="card-header" id="heading-After-One">
                                            <h5 className="mb-0">
                                                <button className="btn btn-link" data-toggle="collapse" data-target="#collapse-After-One" aria-expanded="true" aria-controls="collapse-After-One">
                                                When will the winners be announced?<i className="ti-plus"></i><i className="ti-minus"></i>
                                                </button>
                                            </h5>
                                        </div>

                                        <div id="collapse-After-One" className="collapse show" aria-labelledby="heading-After-One" data-parent="#accordion3">
                                            <div className="card-body">
                                    ...
                                    <div className="card">
                                        <div className="card-header" id="heading-After-Two">
                                            <h5 className="mb-0">
                                                <button className="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse-After-Two" aria-expanded="false" aria-controls="collapse-After-Two">
                                                Where can we see the winning results?<i className="ti-plus"></i><i className="ti-minus"></i>
                                                </button>
                                            </h5>
                                        </div>
                                        <div id="collapse-After-Two" className="collapse" aria-labelledby="heading-After-Two" data-parent="#accordion3">
                                            <div className="card-body">
                                    ...
                                    <div className="card">
                                        <div className="card-header" id="heading-After-Three">
                                            <h5 className="mb-0">
                                                <button className="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse-After-Three" aria-expanded="false" aria-controls="collapse-After-Three">
                                                When will the E-certificate be sent?<i className="ti-plus"></i><i className="ti-minus"></i>
                                                </button>
                                            </h5>
                                        </div>
                                        <div id="collapse-After-Three" className="collapse" aria-labelledby="heading-After-Three" data-parent="#accordion3">
                                            <div className="card-body">
                                    ...
                                    <div className="card">
                                        <div className="card-header" id="heading-After-four">
                                            <h5 className="mb-0">
                                                <button className="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse-After-four" aria-expanded="false" aria-controls="collapse-After-four">
                                                When is the online delivery of participant certificates?<i className="ti-plus"></i><i className="ti-minus"></i>
                                                </button>
                                            </h5>
                                        </div>
                                        <div id="collapse-After-four" className="collapse" aria-labelledby="heading-After-four" data-parent="#accordion3">
                                            <div className="card-body">
                                    ...
                                    <div className="card">
                                        <div className="card-header" id="heading-After-five">
                                            <h5 className="mb-0">
                                                <button className="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse-After-five" aria-expanded="false" aria-controls="collapse-After-five">
                                                Where can we get a supervisor certificate?<i className="ti-plus"></i><i className="ti-minus"></i>
                                                </button>
                                            </h5>
                                        </div>
                                        <div id="collapse-After-five" className="collapse" aria-labelledby="heading-After-five" data-parent="#accordion3">
                                            <div className="card-body">
                                    ...
                                    <div className="card">
                                        <div className="card-header" id="heading-After-six">
                                            <h5 className="mb-0">
                                                <button className="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse-After-six" aria-expanded="false" aria-controls="collapse-After-six">
                                                How to do medal doubling?<i className="ti-plus"></i><i className="ti-minus"></i>
                                                </button>
                                            </h5>
                                        </div>
                                        <div id="collapse-After-six" className="collapse" aria-labelledby="heading-After-six" data-parent="#accordion3">
                                            <div className="card-body">
