    ...
    <section className="video_area bg_color sec_pad">
      <div className="container">
        <Sectitle
          ...
          Title1="INTERNATIONAL SCIENCE AND INVENTION FAIR 2022"
          Title2="International Science and Invention Fair or known as ISIF is the biggest event organized by IYSA. In this year IYSA hold again this event for the 4th time and we holding it by hybrid online and offline in Bali, at Ganesha University of Education, Bali."
          Title3="As the first and biggest event held by IYSA, ISIF has a special place for young researchers. This is proven by the number of participants we got at this event. In 2022 we have 507 participants from 32 countries."
          Title4="Several countries participating in ISIF include Indonesia, Bangladesh, Lebanon, Malaysia, Thailand, Bulgaria, India, Puerto Rico, South Korea, Philippines, Iran, United Arab Emirates, Turkey, Egypt, Columbia, Belarusia, Romania, Brazil, Algeria, Saudi Arabia, Paraguay, Mexico, Nigeria, Nepal, Hong Kong, Serbia, Vietnam, Italy, Bolivia, Macau, China, Singapore, Kazakhstan, and 9 countries (Indonesia, Malaysia, Vietnam, Paraguay,Bangladesh,Mexico, Columbia,  Romania, and Iran)  participated face to face (offline) in ISIF Bali this year."
        ...
        <div className="video_content">
          <div className="video_info">
            ...
            <a
              ...
              target="-blank"
              href="https://www.youtube.com/watch?v=OLkXTJuKpOs"
            >
